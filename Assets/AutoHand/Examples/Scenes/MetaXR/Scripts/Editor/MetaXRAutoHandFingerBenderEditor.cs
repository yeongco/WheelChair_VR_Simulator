...
namespace Autohand {
    [CustomEditor(typeof(MetaXRAutoHandFingerBender))]
    public class MetaXRAutoHandFingerBenderEditor : Editor{
        MetaXRAutoHandFingerBender bender;

        void OnEnable() {
            bender = target as MetaXRAutoHandFingerBender;
        }
