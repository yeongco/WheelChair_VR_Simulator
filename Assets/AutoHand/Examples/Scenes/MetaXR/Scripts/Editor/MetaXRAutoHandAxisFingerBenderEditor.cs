...
namespace Autohand {
    [CustomEditor(typeof(MetaXRAutoHandAxisFingerBender))]
    public class MetaXRAutoHandAxisFingerBenderEditor : Editor{
        MetaXRAutoHandAxisFingerBender bender;

        void OnEnable() {
            bender = target as MetaXRAutoHandAxisFingerBender;
        }
