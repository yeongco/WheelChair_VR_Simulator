...
namespace Autohand {
    public class MetaHandGestureEventTextWriter : MonoBehaviour {
        public MetaHandGestureEvent handGestureEvent;
        ...
        void OnGestureStart(Hand hand, MetaHandPoseGestureData data) {
            currentPoseDistance.color = Color.green;
        }

        void OnGestureStop(Hand hand, MetaHandPoseGestureData data) {
