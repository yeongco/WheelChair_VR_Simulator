...
namespace Autohand {
    ...
    public delegate void FingerTouchStartEvent(MetaXRAutoHandTracking hand, MetaHandFingerGestureTracker gestureTracker, FingerTouchEventArgs e);
    public delegate void FingerTouchStopEvent(MetaXRAutoHandTracking hand, MetaHandFingerGestureTracker gestureTracker, FingerTouchEventArgs e);

    public class MetaHandFingerGestureTracker : MonoBehaviour {
        public MetaXRAutoHandTracking handTracking;
